  ...
  const experiences = [
    {
      ...
      company: "Bitspro",
      description:
        "Developed responsive and interactive user interfaces using React.js and Tailwind CSS. Worked on form handling and UI components for an inventory management system, ensuring a smooth user experience. Collaborated with the team to integrate frontend features and improve overall usability.",
      technologies: ["React", "TypeScript", "Tailwindcss", "ShadcnUI","Tanstack Query"],
      current: true,
    },
  ];
  return (
